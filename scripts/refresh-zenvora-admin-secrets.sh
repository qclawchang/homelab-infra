...
KEYS="TOKEN_ENCRYPTION_KEY WHITELISTED_GITHUB_USER_ID GITHUB_APP_CLIENT_ID GITHUB_APP_CLIENT_SECRET ALERT_CHECK_TOKEN ALERT_CHECK_TOKEN_PERSONAL SMTP_HOST SMTP_PORT SMTP_SECURE SMTP_USER SMTP_PASS ALERT_EMAIL_FROM ALERT_EMAIL_TO"
